...
This release wasn't going to show whether LocoVoco will be a global success, I believe it will be 🙏, but we need far more data and users before we can show that is the case. 
...
<div class="row">
  <div class="column">
        <img src="/resources/post/2021-12-06-trial2/MeetupFred.png" class="blog-img" alt="Snow" style="width:300px;">
  </div>
  <div class="column">
        <img src="/resources/post/2021-12-06-trial2/MeetupMelissa.png" class="blog-img" alt="Forest" style="width:300px;">
  </div>
</div>  

Previously if someone accepted your invite, that was it you had no option to decide whether to accept the accepting user or whether to wait and see who else wants to accept your invite. In our new release you can pass and wait to see who else will accept your invite.
...
A user had a no show and it was our fault 😬. They traveled on the bus for 45 minutes to the West End and ended up not meeting the other user. The other user had emailed us that they wouldn't make the meetup but we hadn't read the mail in time so couldn't inform the user.
...
* We will be adding cafes in the East End of Glasgow for users to meet up at.
...
If anyone has any comments about content in this blog post or any ideas/feedback about the release please add a comment in the comments section at the bottom of this page.

### Thanks to everyone who took part

For everyone who installed the app, we are incredibly grateful for trialing it at this early stage, as a token of our appreciation, we're offering a £5 off voucher 🎁  at one of the cafes involved in the trial run.
